...
>>>>>>> 435332a8e974c81a4ce2e01daa6d70a9c45e6b8b
                @endforeach
            </div>
        </div>
        <div class=" pt-16">
                    ...
                    @foreach ($nowPlayingMovies as $now_movies)
                        <div class="mt-8">
                            <a href="{{ route('movies.show', $now_movies['id']) }}">
                                <img src="{{ $now_movies['backdrop_path'] }}"
                                    alt="parasite" class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                            <div class="mt-2">
                                <a href="{{ route('movies.show', $now_movies['id']) }}"
                                    class="text-lg mt-2 hover:text-gray-300">{{ $now_movies['original_title'] }}</a>
                                <div class="flex items-center text-gray-400">
                                    <span><i class="fas fa-star fill-current text-yellow-500 w-4"></i></span>
                                    <span class="ml-1">{{ $now_movies['vote_average']}}</span>
                                    <span class="mx-2">|</span>
